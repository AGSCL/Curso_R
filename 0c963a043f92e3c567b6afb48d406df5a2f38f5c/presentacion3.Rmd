...
plot(coronavirus$mes,coronavirus$monto_invertido_med, xlab="Mes",ylab="Monto Invertido Med.")
```
...
reshape(coronavirus, v.names = "infectados", idvar = "estado", timevar = "mes", direction = "wide")
```
