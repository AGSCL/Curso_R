...
Gastos_casa_csv <- read.delim("G:/Mi unidad/Alvacast/Curso/Gastos_casa_csv.txt") ##CADA UNO DEBE CAMBIAR LA RUTA DE OBTENCIÓN DEL ARCHIVO, DEPENDIENDO DEL DIRECTORIO DONDE LO GUARDOÓ. SE ACONSEJA GUARDARLO EN LA MISMA CARPETA QUE EL PROYECTO.
```
...
mean(Gastos_casa_csv$monto, na.rm=T) #Utilizar este argumento.
```

```{r mediana, echo=T, warning=F, size = 'tiny'}
median(Gastos_casa_csv$monto, na.rm=T) #Utilizar este argumento.
```
