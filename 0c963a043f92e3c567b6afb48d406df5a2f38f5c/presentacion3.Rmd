...
```{r scatter, echo=T, warning=F, size = 'tiny'}
plot(Gastos_casa_csv$monto,Gastos_casa_csv$monto, xlab="Monto",ylab="Monto")
```
...
- Bajar [BASE DE DATOS](https://raw.githubusercontent.com/AGSCL/Curso_R/master/0c963a043f92e3c567b6afb48d406df5a2f38f5c/depositos_a_plazo.xlsx)
...
library(readxl)
depositos_a_plazo <- read_excel("G:/Mi unidad/Alvacast/Curso/0c963a043f92e3c567b6afb48d406df5a2f38f5c/coronavirus.xlsx", 
    sheet = "Hoja1")
str(depositos_a_plazo)
```

- Datos de Ancho y largo (`reshape()`)

```{r cargar_xlsx, echo=T, warning=F, size = 'tiny'}
reshape(depositos_a_plazo, varying=c("monto_invertido", "monto_vencimiento"), idvar = "estado", timevar = "orden", direction = "wide")
```
