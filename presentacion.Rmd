...
```{r data, echo=TRUE}
set.seed(4567)
df<- data.frame(numeros=round(rnorm(1:200)*100,0))
```
...
- Súmelas
- ¿Llegó al siguiente número: `r sum(tail(df2))`?
...
- Guarde los datos (.Rdata) y el proyecto (.RProj)
- Reinicie el computador. Vuelva a abrirlo
